...
async function addOrderToSheet(orderData) {
  try {
    ...
    await sheet.addRow({
      ...
      'Price (USD)': orderData.price_usd !== undefined ? orderData.price_usd : orderData.price || '',
...
async function getProductsFromSheet() {
  try {
      ...
      await sheet.addRows([
        {
          ...
          Price: '299.99',
          'Image URL': 'https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=305&h=305&fit=crop&q=80',
          Category: 'Rings',
        ...
        },
        {
          ...
          Price: '149.99',
          'Image URL': 'https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?w=305&h=305&fit=crop&q=80',
          Category: 'Necklaces',
        ...
        },
        {
          ...
          Name: 'Pearl Earrings',
          Price: '89.99',
          'Image URL': 'https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=305&h=305&fit=crop&q=80',
          Category: 'Earrings',
        ...
        },
        {
          ...
          Price: '199.99',
          'Image URL': 'https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=305&h=305&fit=crop&q=80',
          Category: 'Bracelets',
    ...
    return rows.map((row) => ({
      ...
      image_url: row.get('Image URL') || 'https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?w=305&h=305&fit=crop&q=80',
